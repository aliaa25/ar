...
// components/common/ResponsiveARView.jsx
// import React, { useState, useEffect } from 'react';
// import { X, Plus, Menu } from 'lucide-react';
// import { useFooter } from "@/components/providers/FooterContext";
...
//   // 🔼⬇️ Functions to move camera vertically
//   const moveUp = () => {
...
//       {/* 🔼⬇️ Vertical Movement Buttons - Mobile only */}
//       <div className="fixed left-4 bottom-24 z-50 flex flex-col gap-2">
//         <button
//           onClick={moveUp}
//           className="bg-white text-black rounded-full shadow-md p-3 text-xl touch-manipulation"
//           aria-label="Move Up"
//         >
//           ⬆️
//         </button>
